...
void resnetModel(unsigned int L1Memory, unsigned int L2Memory, unsigned int L3Memory, unsigned int L3Flash)
{
    ...
    CNN_MatAdd("S18_MatAdd_8x39x39", 0, 2, 2, 2, 10, 10, 10, 1, 1, 1, 8, 8, 39, 39, KOP_MATADD);
...
#define GRAPH
    ...
    CreateGraph("resnetCNN",
        /* Arguments either passed or globals */
            CArgs(44,
                ...
                TCArgInfo("signed short * __restrict__", "Res2cbranch2bkernel", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_16BIT/tensors/Res2cbranch2bkernel.tensor", 1, 1, 16, 14)),
                ...
                TCArgInfo("signed short * __restrict__", "Res3a_branch2aconv2d_bias", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_16BIT/tensors/Res3a_branch2aconv2d_bias.tensor", 1, 1, 16, 14)),
                ...
                TCArgInfo("signed short * __restrict__", "Res4a_branch2aconv2d_bias", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_16BIT/tensors/Res4a_branch2aconv2d_bias.tensor", 1, 1, 16, 14)),
                ...
                TCArgInfo("signed short * __restrict__", "Res4a_branch1conv2d_bias", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_16BIT/tensors/Res4a_branch1conv2d_bias.tensor", 1, 1, 16, 14)),
                ...
                TCArgInfo("signed short * __restrict__", "Res4bbranch2aconv2d_bias", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_16BIT/tensors/Res4bbranch2aconv2d_bias.tensor", 1, 1, 16, 14)),
                ...
                TCArgInfo("signed short * __restrict__", "Res5a_branch2aconv2d_bias", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_16BIT/tensors/Res5a_branch2aconv2d_bias.tensor", 1, 1, 16, 14)),
    ...
    // Node S4_Conv2d_8x1x7x7_MaxPool_3x3_Relu inq 15 weightsq 11 outq 12 biasesq 12
    ...
    // Node S7_Conv2d_8x8x3x3_Relu inq 12 weightsq 15 outq 12 biasesq 14
    ...
    // Node S10_Conv2d_8x8x3x3 inq 12 weightsq 14 outq 10 biasesq 13
    ...
    // Node ADD_0_5 inq1 10 inq2 12 outq 10
    ...
    // Node S14_Conv2d_8x8x3x3_Relu inq 10 weightsq 15 outq 12 biasesq 14
    ...
    // Node S17_Conv2d_8x8x3x3 inq 12 weightsq 14 outq 10 biasesq 14
    ...
    // Node ADD_0_8 inq1 10 inq2 10 outq 10
    ...
    // Node S21_Conv2d_16x8x3x3_Relu inq 10 weightsq 15 outq 11 biasesq 14
    ...
    // Node S24_Conv2d_16x8x1x1 inq 10 weightsq 15 outq 10 biasesq 15
    ...
    // Node S27_Conv2d_16x16x3x3_Relu inq 11 weightsq 15 outq 12 biasesq 13
    ...
    // Node ADD_0_12 inq1 12 inq2 10 outq 10
    ...
    // Node S31_Conv2d_16x16x3x3_Relu inq 10 weightsq 15 outq 12 biasesq 14
    ...
    // Node ADD_0_15 inq1 11 inq2 10 outq 10
    ...
    // Node S38_Conv2d_32x16x3x3_Relu inq 10 weightsq 15 outq 11 biasesq 14
    ...
    // Node S44_Conv2d_32x32x3x3_Relu inq 11 weightsq 15 outq 12 biasesq 13
    ...
    // Node S48_Conv2d_32x32x3x3_Relu inq 11 weightsq 15 outq 12 biasesq 14
    ...
    // Node S51_Conv2d_32x32x3x3 inq 12 weightsq 15 outq 11 biasesq 13
    ...
    // Node ADD_0_22 inq1 11 inq2 11 outq 10
    ...
    // Node S55_Conv2d_64x32x3x3_Relu inq 10 weightsq 15 outq 12 biasesq 14
    ...
    // Node S58_Conv2d_64x32x1x1 inq 10 weightsq 15 outq 11 biasesq 14
    ...
    // Node S61_Conv2d_64x64x3x3_Relu inq 12 weightsq 15 outq 12 biasesq 13
    ...
    // Node ADD_0_26 inq1 12 inq2 11 outq 11
    ...
    // Node S65_Conv2d_64x64x3x3_Relu inq 11 weightsq 15 outq 12 biasesq 15
    ...
    // Node S68_Conv2d_64x64x3x3 inq 12 weightsq 15 outq 11 biasesq 13
    ...
    // Node ADD_0_29 inq1 11 inq2 11 outq 10
    ...
    // Node AVERAGE_POOL_2D_0_30 inq Q6.10 outq Q6.10
    AddNode("S70_AveragePool_2x2", Bindings(2, GNodeArg(GNA_IN, "S69_Output", 0), GNodeArg(GNA_OUT, "S70_Output", 0)));
    // Node FULLY_CONNECTED_0_31 inq 10 weightsq 15 outq 10
    AddNode("S73_Linear_7x64x2x2", Bindings(4, GNodeArg(GNA_IN, "S70_Output", 0), GNodeArg(GNA_IN, "Full_connection7kerneltranspos", 0), GNodeArg(GNA_IN, "Full_connection7matmul_bias", 0), GNodeArg(GNA_OUT, "S73_Output", 0)));
